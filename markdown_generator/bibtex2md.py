...
# Code taken from: https://valeriobasile.github.io/Managing-my-own-bibliography/
...
with open('../files/my_publications.bib') as bibtex_file:
...
with open('publication_list.md', 'w') as md_file:
    for bib_item in bib_database.entries:
        ...
        with open('../files/{0}'.format(bib_file), 'w') as bib:
