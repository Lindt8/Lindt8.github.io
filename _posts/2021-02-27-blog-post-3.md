...
| Description	|	Schematic showing the beam, target, and shadow bar configurations.	|
{: .tablelines}
...
| Made with | LaTeX |
| Context	|	My Ph.D. work [[1](https://trace.tennessee.edu/utk_graddiss/5323/)] |
| Description	|	Table designating the stopping locations of beams.	|
{: .tablelines}
...
| Made with | Python |
| Context	|	My Ph.D. work [[1](https://trace.tennessee.edu/utk_graddiss/5323/)]  |
| Description	|	Light response function of a 5" x 5" organic liquid scintillator to incident neutrons.	|
{: .tablelines}
...
| Made with | LaTeX (TikZ) |
| Context	|	My Ph.D. work [[1](https://trace.tennessee.edu/utk_graddiss/5323/)]  |
| Description	| Diagram illustrating the various point, distances, and angles involved in calculating detector solid angles.	|
{: .tablelines}
