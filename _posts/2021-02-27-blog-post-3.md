...
| -------- | ----------- |
| Made with | Python (PyGal + custom SVG code) |
| Context	|	My work with the PHITS group [[most up-to-date charts](https://phits.jaea.go.jp/)]  |
| Description	|	World map showing the number of PHITS users per country (since April 2019, version 3.10), generated with an in-house tool I developed which uses an interface made with PySimpleGUI.	|
{: .tablelines}

<!-- <div style="text-align: center;"><img src="/files/figures/JAEA/PHITS_map_userbase.svg" style="width:90%;"> </div> -->

{% include_relative files/figures/JAEA/PHITS_map_userbase.svg %}

<div style="text-align: center;"><object data="/files/figures/JAEA/PHITS_map_userbase.svg" type="image/svg+xml" style="width:90%;"></div>
