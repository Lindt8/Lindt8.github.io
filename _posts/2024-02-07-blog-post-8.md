...
*The only caveat to mention is that this 907-day limit per sheet still exists, and if this is to be exceeded before the 10/9-trip limit per sheet, the next sheet will work fine but only if the final trip of the preceding sheet still fits within the 907-day limit (i.e., there should not be any errors in the main input/results table area for the last trip in any given sheet).*
