...
*Note: The spreadsheet makes use of the [XLOOKUP() function](https://support.microsoft.com/en-au/office/xlookup-function-b7fd680e-6d10-43e6-84f9-88eae8bf5929), which is only available in Excel 2021 and newer. So, opening the spreadsheet in older versions of Excel will result in `#NAME?` errors.*
